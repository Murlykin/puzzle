...
let img = 'https://murlykin.github.io/puzzle/images/pic.jpg';
...
// canv for the moving PolyPiece and the full image
  ...
  if (!this.menu) {
    this.menu = new Menu({
      ...
      lineStep: 30,
      lines: [
        {text: "Завантажити", func: this.loadImage()},
        {text: "12 уламків", func: this.returnFunct(12)},
        {text: "25 уламків", func: this.returnFunct(25)},
        {text: "50 уламків", func: this.returnFunct(50)},
        {text: "100 уламків", func: this.returnFunct(100)},
        {text: "200 уламків", func: this.returnFunct(200) },
        ]
    });
  }
  if (autoStart) {
